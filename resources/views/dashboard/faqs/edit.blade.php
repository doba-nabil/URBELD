...
@section('dashboard-main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header">{{ __('admin.edit_faq') }}</h5>
                    <div class="card-body">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="{{ old("question.$localeCode", $faq->getTranslation('question', $localeCode)) }}">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" name="answer[{{ $localeCode }}]" rows="4">{{ old("answer.$localeCode", $faq->getTranslation('answer', $localeCode)) }}</textarea>
                            ...
                            <div class="row mt-3 p-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="is_active" class="form-select">
                                        <option value="1"
                                            {{ old('is_active', $faq->is_active) == '1' ? 'selected' : '' }}>{{ __('admin.active') }}</option>
                                        <option value="0"
                                            {{ old('is_active', $faq->is_active) == '0' ? 'selected' : '' }}>{{ __('admin.inactive') }}
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-6">
