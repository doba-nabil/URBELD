...
<head>
    ...
    <title>{{ \App\Models\Setting::getValue('site_name', app()->getLocale(), 'URBELD') }}</title>
                ...
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center mb-6">
                        ...
                        <span class="app-brand-logo demo">
                                <img height="80" src="{{ \App\Models\Setting::getMediaUrl('logo_ar') ?: (\App\Models\Setting::getMediaUrl('favicon') ?: asset('dashboard/assets/img/logo/logo.png')) }}">
                        </span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-1 text-center">{{ __('admin.welcome_to_dashboard') }}</h4>
                    <p class="mb-6 text-center">{{ __('admin.please_login') }}</p>

                    <form id="formAuthentication" class="mb-6" action="{{ url('admin-panel/login') }}" method="POST">
                        @csrf
                        ...
                        <button class="btn btn-primary d-grid w-100">{{ __('admin.login_button') }}</button>
                    </form>
                </div>
            </div>
            <!-- /Login -->
