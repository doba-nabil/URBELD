...
class ActivityTypeDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('requests_count', function ($q) {
                $count = $q->serviceRequests()->count();
            ...
            ->addColumn('is_active', function ($q) {
                return $q->is_active
                    ...
                    : '<span class="badge bg-label-secondary">' . __('admin.unactive') . '</span>';
            })
            ->addColumn('action', function ($q) {
                $editUrl = url('/admin-panel/activity-types/' . $q->id . '/edit');
                $deleteUrl = url('/admin-panel/activity-types/' . $q->id);
        ...
        <div class="dropdown">
            ...
            ->rawColumns(['action', 'name', 'requests_count', 'is_active'])
            ->setRowId('id');
    }

    public function query(ActivityType $model): QueryBuilder
    {
        return $model->newQuery()->withCount('serviceRequests');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('requests_count')->title(__('admin.requests_count'))->addClass('text-center'),
    ...
    {
        return 'ActivityTypes ' . date('Y-m-d');
    }
