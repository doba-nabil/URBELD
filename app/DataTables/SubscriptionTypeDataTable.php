...
class SubscriptionTypeDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($q) {
                $editUrl = route('subscription-types.edit', $q->id);
                $deleteUrl = route('subscription-types.destroy', $q->id);
                return '
                    <div class="dropdown">
    ...
    public function query(SubscriptionType $model): QueryBuilder
    {
